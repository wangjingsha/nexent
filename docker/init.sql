...
INSERT INTO "agent_engine"."model_record_t" ("model_repo", "model_name", "model_factory", "model_type", "api_key", "base_url", "max_tokens", "used_token", "delete_flag", "create_time", "update_time", "display_name", "connect_status", "updated_by", "created_by") VALUES ('', 'jina-clip-v2', 'OpenAI-API-Compatible', 'embedding', 'jina_36574bd4eefb4e9da2b3cbbc507cfdd0F_zt54HV8jmbcLHfqD6v7fI0IbEO', 'https://api.jina.ai/v1/embeddings', 0, 0, 'N', NULL, NULL, 'jina-clip-v2', '不可用', NULL, NULL);